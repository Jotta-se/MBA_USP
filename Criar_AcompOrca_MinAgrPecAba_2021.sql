...
CREATE TABLE [AcompanhamentoOrcamentario].[dbo].[_AcompOrca_MinAgrPecAba_2022] (
...
INSERT INTO [AcompanhamentoOrcamentario].[dbo].[_AcompOrca_MinAgrPecAba_2022]
SELECT 
    ...
    CAST(LOA.[projetolei] AS FLOAT) AS [projetolei],
    CAST(LOA.[dotacaoinicial] AS FLOAT) AS [dotacaoinicial],
    CAST(LOA.[autorizado] AS FLOAT) AS [autorizado],
    ...
    CAST(LOA.[autorizado_po] AS FLOAT) AS [autorizado_po],
    ...
    CAST(LOA.[fisicoreprogramado_po] AS FLOAT) AS [fisicoreprogramado_po],
    CAST(LOA.[fisicoreprogramado_po] AS FLOAT) AS [financeiroreprogramado_po],
...
FROM
    [AcompanhamentoOrcamentario].[dbo].[_LOA_2022] LOA
